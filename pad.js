...
//			basemap: "streets",
		...
		//符号渲染器
		var iconrenderer = new UniqueValueRenderer(new PictureMarkerSymbol('images/建筑.png', 20, 20), "btype");
		iconrenderer.addValue('0', new PictureMarkerSymbol('images/住宅.png', 20, 20));
		iconrenderer.addValue('1', new PictureMarkerSymbol('images/商业.png', 20, 20));
		iconrenderer.addValue('2', new PictureMarkerSymbol('images/公用.png', 20, 20));
